import { useSplitsClient, SplitsProvider } from '@0xsplits/splits-sdk-react'
...
export { DisplaySplitViaProvider } from './components/DisplaySplit'
export type { IDisplaySplitProps } from './components/DisplaySplit'

export { useSplitsClient, SplitsProvider }
